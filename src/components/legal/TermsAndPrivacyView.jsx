    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col items-center p-4 sm:p-6">
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-sm border border-slate-200/80 p-6 sm:p-10 space-y-8">
          ...
          <div className="space-y-6 text-sm text-slate-600 leading-relaxed animate-in fade-in duration-150">
            ...
            <div className="bg-amber-50/80 border border-amber-200/80 rounded-2xl p-4 space-y-1.5">
              ...
              <p className="text-xs text-amber-900/90 leading-relaxed font-medium">
                The devotionals, guided audios, and AI Spiritual Guide provided by DailyGrace App are designed for personal faith encouragement, spiritual growth, and daily meditation. DailyGrace App is not a medical or psychological healthcare provider.
              </p>
            </div>
            ...
            <section className="space-y-2">
              ...
              <p>
                By creating an account, accessing, or utilizing the DailyGrace application and related digital services, you confirm that you have read, understood, and agreed to be bound by these Terms of Service.
              </p>
            </section>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-extrabold text-slate-900">3. AI Spiritual Guide & Grace Credits</h2>
              <p>
                DailyGrace App provides AI-powered spiritual guidance and scripture reflections. Responses generated by the AI Guide are automated to assist in biblical study and prayer.
              </p>
            </section>
          ...
          <div className="space-y-6 text-sm text-slate-600 leading-relaxed animate-in fade-in duration-150">
            ...
            <div className="bg-emerald-50/80 border border-emerald-200/80 rounded-2xl p-4 space-y-1.5">
              ...
              <p className="text-xs text-emerald-900/90 leading-relaxed font-medium">
                DailyGrace App is committed to safeguarding your personal data and prayer requests with industry-standard encryption. We never sell or share your data with advertisers.
              </p>
            </div>
            ...
            <section className="space-y-2">
              ...
              <p>
                We use collected information exclusively to deliver, maintain, and personalize the DailyGrace experience, sync devotional chapters, and provide responses from our AI Spiritual Guide.
              </p>
            </section>
            ...
            <section className="space-y-2">
              ...
              <p>
                DailyGrace App integrates with trusted infrastructure partners (e.g., Google Firebase for database operations). These providers process data strictly in compliance with applicable privacy regulations.
              </p>
            </section>
          </div>
        )}
        ...
        <div className="border-t border-slate-100 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-400">
          <span>&copy; 2026 DailyGrace App. All rights reserved.</span>
